...
--
-- FIXME add module description for Coconut.Graph.TopSort
-- Consider moving me to Coconut.Utils?
...
instance NodeSet [Node] where
  insertNode n ns = nub (n:ns)
  extractNode [] = Nothing
  extractNode (n:ns) = Just (n,ns)
