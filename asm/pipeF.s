...
PIPELINED   ALIAS C'pipeF'
    ...
    sgr   rFIFOIDX,rFIFOIDX * zero rFIFOIDX
...
S1 DS 0H
    ...
    vfa     v13,v3,v5,3,0
    vfa     v14,v4,v5,3,0
    vst     V11,FIFOOFF+64+0(rFIFOIDX,r4)
    vst     V12,FIFOOFF+64+16(rFIFOIDX,r4)
    vst     V13,FIFOOFF+64+32(rFIFOIDX,r4)
    vst     V14,FIFOOFF+64+48(rFIFOIDX,r4)
...
S1S2S3 DS 0H
    ...
    vl      V11,FIFOOFF+64+0(rFIFOIDX,r4)
    vl      V12,FIFOOFF+64+16(rFIFOIDX,r4)
    vl      V13,FIFOOFF+64+32(rFIFOIDX,r4)
    vl      V14,FIFOOFF+64+48(rFIFOIDX,r4)
    vfa     v6,v11,v6,3,0
    vfa     v7,v12,v7,3,0
    vfa     v8,v13,v8,3,0
    vfa     v9,v14,v9,3,0
...
FIFOOFF  EQU   *-MYDSA
FIFOS    DS    24L             * FIXME make this a min of 4 and needed
MYDSASZ  EQU   *-MYDSA
