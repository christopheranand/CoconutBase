...
DATA p256vmsl<>+0x00(SB)/8, $0x0000000000000000
DATA p256vmsl<>+0x08(SB)/8, $0x0000000000000000 // 0x0
...
DATA p256vmsl<>+0x30(SB)/8, $0x0000000000000000
DATA p256vmsl<>+0x38(SB)/8, $0x0000000010111213 // 0x010111213
DATA p256vmsl<>+0x40(SB)/8, $0x0000000000000000
DATA p256vmsl<>+0x48(SB)/8, $0x1011121314151617 // 0x1011121314151617
DATA p256vmsl<>+0x50(SB)/8, $0x0000000000001011
DATA p256vmsl<>+0x58(SB)/8, $0x1213141516171819 // 0x10111213141516171819
DATA p256vmsl<>+0x60(SB)/8, $0x0000000000000000
DATA p256vmsl<>+0x68(SB)/8, $0x18191a1b1c1d1e1f // 0x18191a1b1c1d1e1f
DATA p256vmsl<>+0x70(SB)/8, $0x00000000008090a0
DATA p256vmsl<>+0x78(SB)/8, $0xbc0d0e0f10111213 // 0x8090a0bc0d0e0f10111213
DATA p256vmsl<>+0x80(SB)/8, $0x0000000014151617
DATA p256vmsl<>+0x88(SB)/8, $0x18191a1b1c1d1e1f // 0x1415161718191a1b1c1d1e1f
DATA p256vmsl<>+0x90(SB)/8, $0x000000001a1b1c1d
DATA p256vmsl<>+0x98(SB)/8, $0x1e1f000000000000 // 0x1a1b1c1d1e1f000000000000
DATA p256vmsl<>+0xa0(SB)/8, $0x0000000014151617
DATA p256vmsl<>+0xa8(SB)/8, $0x18191a1b1c1d1e1f // 0x1415161718191a1b1c1d1e1f
DATA p256vmsl<>+0xb0(SB)/8, $0x00405060708090a0
DATA p256vmsl<>+0xb8(SB)/8, $0xbc0d0e0f14151617 // 0x405060708090a0bc0d0e0f14151617
DATA p256vmsl<>+0xc0(SB)/8, $0x0c0d0e0f14151617
DATA p256vmsl<>+0xc8(SB)/8, $0x18191a1b1c1d1e1f // 0xc0d0e0f1415161718191a1b1c1d1e1f
DATA p256vmsl<>+0xd0(SB)/8, $0x0000121314151617
DATA p256vmsl<>+0xd8(SB)/8, $0x18191a1b1c1d1e1f // 0x12131415161718191a1b1c1d1e1f
DATA p256vmsl<>+0xe0(SB)/8, $0x0000000000000000
...
TEXT p256MulInternal<>(SB), NOSPLIT, $0-0
	...
	VSLDB $12, ADD2, ADD1, T0 // ADD1 Free
	VSLDB $12, T2, ADD2, T1   // ADD2 Freep256MulInternal
